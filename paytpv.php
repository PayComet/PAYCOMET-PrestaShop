...
class Paytpv extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        if (array_key_exists('PAYTPV_APM_BIZUM', $config)) {
            $this->firstpurchase_scoring = $config['PAYTPV_APM_BIZUM'];
        }
        ...
        try {
            if (!isset($this->apikey) || !isset($this->clientcode) || $this->clientcode=="" || !PaytpvTerminal::existTerminal()) {
    ...
    private function validatePaycomet()
    {
        ...
        foreach (array_keys(Tools::getValue("term")) as $key) {
            ...
            // Verificamos que tiene el TPV Seguro
    ...
    public function getUserAlternativePaymentMethods()
    {
        ...
        } else if (PaytpvTerminal::getTerminals()) {
    ...
    public function hookDisplayPaymentReturn($params)
    {
        ...
        if (strstr(strtolower($order->payment),"multibanco")) {
