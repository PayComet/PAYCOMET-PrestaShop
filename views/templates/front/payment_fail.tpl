...
<ul class="footer_links">
	...
	<li>
		<a href="{$link->getPageLink('order',false, NULL,'step=3')|escape:'htmlall':'UTF-8':FALSE}" title="{l s='Select payment method'  mod='paytpv'}">
			<img src="{$base_dir|escape:'htmlall':'UTF-8':FALSE}img/admin/cart.gif" alt="{l s='Select payment method' mod='paytpv'}" class="icon" />&nbsp;{l s='Select payment method'  mod='paytpv'}
	    </a>
	</li>
	<li>&nbsp;&nbsp;</li>
	<li>
