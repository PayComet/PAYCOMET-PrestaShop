        ...
        <div class="span6" id="div_tarjetas">
            ...
            {section name=card loop=$saved_card['valid']}
                <div class="bankstoreCard" id="card_{$saved_card['valid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}">
                    ...
                    <input type="text" maxlength="32" style="width:300px" id="card_desc_{$saved_card['valid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}" name="card_desc_{$saved_card['valid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}" value="{$saved_card['valid'][card].CARD_DESC|escape:'htmlall':'UTF-8':FALSE}" placeholder="{l s='Add a description' mod='paytpv'}">
                    <label class="button_del">
                        ...
                        <input type="hidden" name="cc_{$saved_card['valid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}" id="cc_{$saved_card['valid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}" value="{$saved_card['valid'][card].CC|escape:'htmlall':'UTF-8':FALSE}">
                    </label>
                </div>
            {/section}
        </div>
            ...
            {section name=card loop=$saved_card['invalid']}
                <div class="bankstoreCard" id="card_{$saved_card['invalid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}">
                    ...
                    <label class="button_del">
                        ...
                        <input type="hidden" name="cc_{$saved_card['invalid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}" id="cc_{$saved_card['invalid'][card].IDUSER|escape:'htmlall':'UTF-8':FALSE}" value="{$saved_card['invalid'][card].CC|escape:'htmlall':'UTF-8':FALSE}">
                    </label>
                </div>
            {/section}
        </div>
