    ...
    *}
    ...
    <ul>
        <li>
            ...
            <div id="paycomet-pan" style="height:36px; padding:0px;">
                <input required="required" paycomet-style="width: 12.5em; border: 1px solid #e5e5e5; height: 32px; display: inline-block; color: #333;font-size: 18px; padding: 0 5px;" paycomet-name="pan">
            </div>
        </li>
        <li class="vertical">
            <ul>
                ...
                <li>
                    ...
                    <div id="paycomet-cvc2" style="height: 36px; padding:0px;">
