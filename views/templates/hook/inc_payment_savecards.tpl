{*
    ...
    *}
    ...
    <div id="storingStep" class="alert alert-info {if (sizeof($saved_card))>1}hidden{/if}" style="clear:left;">
        ...
        <div class="checkbox"><input type="checkbox" name="savecard" id="savecard" onChange="saveOrderInfoJQ(0)" {if (!$remembercardunselected==1)} checked="true"{/if}>
            <label for="savecard" style="display:inline!important"> {l s='Yes, remember my card accepting the ' mod='paytpv'}</label>
