...
if (!class_exists('ClassRegistro')) {
    class ClassRegistro
    {
        ...
        {
            return (ClassRegistro::executeS('

        SELECT w.`id_registro`, w.`id_customer`, w.`id_cart`, w.`amount`, w.`date_add`, w.`error_code`, c.`lastname`
        AS customer_lastname, c.`firstname` AS customer_firstname
