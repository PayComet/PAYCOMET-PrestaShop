...
class PaytpvOrderInfo extends ObjectModel
{
    ...
    public static function saveOrderInfo(
        ...
        $sql = 'DELETE FROM '. _DB_PREFIX_ .'paytpv_order_info where id_customer = '.(int)$id_customer
    ...
    {
        $sql = 'select * from ' . _DB_PREFIX_ .'paytpv_order_info where id_customer = '.(int)$id_customer
        .' and id_cart="'.(int)$id_cart.'"';
